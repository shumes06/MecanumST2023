...
public class OctoAutonBlueLeft extends LinearOpMode {
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        while (!isStarted() && !isStopRequested()) {
            ...
            telemetry.addData("Color", octoColor2.maxColor);
            telemetry.addLine();
            telemetry.addLine("Colors: Heavy debug");
            telemetry.addData("Green", octoColor2.green);
            telemetry.addData("Orange", octoColor2.orange);
            telemetry.addData("Purple", octoColor2.purple);
            telemetry.update();
        }
        ...
        int maxColor = octoColor2.maxColor;
    ...
    void webcamSetup() {
        ...
        webcam.setPipeline(new octoColor2());
...
class octoColor2 extends OpenCvPipeline {
    public static int maxColor = 0;
